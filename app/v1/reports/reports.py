                ...
                if category == "rent":
                    if bill.rent_due:
                        ...
                        if tenant_obj_check[0] == "occupied":
                            ...
                            phone = ""
                        new_line = f"<p class='ln-10'>{bill.house} Name&Phone: {tenant_obj_check[1].name} {phone}, Bal :{bill.rent_due:,.0f}</p>"
                        start += 1
                        sms_text += new_line
...
class CombinedReport(Resource):
    ...
    def get(self):
        ...
        if not selected_apartment:
            ...
            if current_user.company.id == 1144444444444444444444444444444444444444444:
    ...
    def get(self):
        ...
        if raw_tenant:
            if raw_tenant.startswith("Vac"):
                ...
                tenant_id = tenant_obj.id
                if tenant_id == 12802:
                    house_obj = get_specific_house_obj(tenant_obj.apartment_id,"403")
                else:
        ...
        if house_obj:
            ...
            for item in range_period_data:
                ...
                date = item.date.strftime("%d/%b/%y")
                # rdate = generate_exact_date(item.date.day,item.date.month,item.date.year)
    ...
    def get(self):
        ...
        if target == "tills":
            ...
            elements = {
                ...
                "vp": ['9233777', '9233775','9233773','9233771','9565869','9565867','9565865','9565863','5156245','5156247','5030317','All'],
...
class FetchHouses(Resource):
    ...
    def get(self):
        ...
        if crm(current_user):
            template = "ajax_houselist2.html" 
        elif erp(current_user):
            template = "ajax_houselist_erp.html" 
        else:
            template = "ajax_houselist.html"
...
class FetchRates(Resource):
    def get(self):
        ...
        if crm(current_user):
            template = "ajax_housecodelist2.html"
        elif erp(current_user):
            template = "ajax_housecodelist_erp.html"
        else:
            template = "ajax_housecodelist.html"
