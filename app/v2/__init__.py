...
# api.add_resource(RegisterUser,"/add/user", endpoint="user")
...
# # ADMIN ROUTES
api.add_resource(Properties,"/properties", strict_slashes=False)
api.add_resource(Property,"/property/<int:propertyId>")
...
# api.add_resource(EditProp,"/properties/<int:propertyId>")
