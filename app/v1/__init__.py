...
api.add_resource(FetchChangeRequests,"/fetch/changerequests")
api.add_resource(ApproveTransactionChange,"/approve/transactionchange")
...
api.add_resource(StockTransactions,"/v2/stock/transactions")
...
api.add_resource(StockValueReport,"/v2/stock/value/report")

api.add_resource(AI,"/api/tenants")

api.add_resource(Paywall,"/account/suspended")
api.add_resource(UpdateCommissionPercentage,"/update/commission")
